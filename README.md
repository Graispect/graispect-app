...
- designed the ui using figma and sketch.
- created all icons manually in procreate. 
- built the app from scratch using swiftui.
- implemented custom interaction flows.
